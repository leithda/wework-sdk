...
public class WeworkExternalContactService extends WeworkBaseService {
    ...
    public BatchGetExternalContactResponse batchGetExternalContact(String corpId, BatchGetExternalContactRequest request) {
        ...
        do {
            BatchGetExternalContactResponse batchGetExternalContactResponse = executePost(EXTERNAL, corpId, null, false, BatchGetExternalContactResponse.class, BATCH_GET_EXTERNAL_CONTENT_URL, request);
    ...
    public BaseResponse remarkExternalContact(String corpId, RemarkExternalContactRequest request) {
        return executePost(EXTERNAL, corpId, null, false, BaseResponse.class, REMARK_EXTERNAL_CONTACT_URL, request);
    }
